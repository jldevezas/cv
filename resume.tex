...
\skills{Python, ETL, PostgreSQL, JanusGraph, \mbox{Redis}, Financial Indicators, Data Visualization, Jupyter, Time Series Forecasting, Transformers, LSTMs, Indexing and Search, Sentiment Analysis, Full-Stack \mbox{Development}, Flask, Vue.js, Tachyons}\\}
\end{entrylist}
\begin{entrylist}
%------------------------------------------------
\entry
