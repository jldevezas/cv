...
\tcbset{colframe=red, colback=white, boxrule=.5pt, arc=.75em, sharp corners=downhill,
  left=1em, right=1em, top=.5em, bottom=.5em, enlarge top by=-.9em, enlarge bottom by=.1em}
...
\newcommand{\infobox}[1]{\tcbox{\parbox{.91\linewidth}{\small #1}}}
...
\begin{itemize}[leftmargin=*]
  ...
  \item \href{https://youtu.be/uDhfL_UvF_Y}{Army ANT}, a workbench for innovation in entity-oriented search.
\end{itemize}

\vspace{1em}

\begin{tabular}{r@{\extracolsep{.75em}}l}
...
\begin{entrylist}
\entry{}{}{}{
\infobox{\languages{Python, Typescript, SQL, Terraform/HCL}\sep \frameworks{FastAPI, Kedro, MLflow}\sep \storage{Neo4j, PostgreSQL, MongoDB, Iceberg}\sep \software{Jupyter, Elasticsearch/Kibana}\sep \services{GCP, AWS, ChatGPT}\sep \skills{R\&D Processes, Text Classification, Graph Data Science, ELT, Prompt Engineering}}}
%------------------------------------------------
\entry
{2021--2023}
{HEX DATUM OÜ}
...
\infobox{\languages{Java, Gremlin, R, Python}\sep \frameworks{Scrapy, SQLAlchemy, Flask, Vue.js, Spectre.css, Bulma}\sep \libraries{igraph, NetworkX, Pandas}\sep \apis{Twitter}\sep \storage{PostgreSQL, MongoDB, Lucene, Neo4j}\sep \software{Jupyter}\sep \skills{Scientific Writing, Experimental Design, Indexing and Search, Web Crawling and Scraping, Social Media Analytics}}}
\end{entrylist}
\begin{entrylist}
%------------------------------------------------
\entry
...
\infobox{\storage{SQLite, MongoDB}\sep \software{Gephi, KNIME}\sep \skills{Educational Content Creation, Slide Presentation, Student Assessment}}}
%------------------------------------------------
\entry
{2014--2015}
{INTERRELATE}
...
\infobox{\languages{Python, Gremlin}\sep \libraries{SciPy, PyMF}\sep \storage{Neo4j, HDF5, Redis}\sep \skills{Recommender Systems, Music Recommendation, Collaborative Filtering, Content Filtering, Graph Analytics}}}
%------------------------------------------------
\entry
{2011--2012}
{CRACS, INESC TEC}
